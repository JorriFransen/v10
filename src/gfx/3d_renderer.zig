...
pub fn init(this: *@This(), render_pass: vk.RenderPass) !void {
    this.layout = try createPipelineLayout();
    this.pipeline = try this.createPipeline(render_pass);
}

pub fn destroy(this: *@This()) void {
    gfx.device.device.destroyPipelineLayout(this.layout, null);
...
fn createPipeline(this: *@This(), render_pass: vk.RenderPass) !Pipeline {
    ...
    return try Pipeline.create("shaders/simple.vert.spv", "shaders/simple.frag.spv", pipeline_config);
}
