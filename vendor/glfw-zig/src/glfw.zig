...
///
///  @ingroup window
pub const getWindowFrameSize = f("glfwGetWindowFrameSize", fn (window: *Window, left: *c_int, top: *c_int, right: *c_int, bottom: *c_int) callconv(.c) void);
...
///
///  @ingroup window
pub const getWindowContentScale = f("glfwGetWindowContentScale", fn (window: *Window, xscale: f32, yscale: f32) callconv(.c) void);
...
///
///  @ingroup window
pub const getWindowOpacity = f("glfwGetWindowOpacity", fn (window: *Window) callconv(.c) f32);
...
///
///  @ingroup window
pub const setWindowOpacity = f("glfwSetWindowOpacity", fn (window: *Window, opacity: f32) callconv(.c) void);
...
///
///  @ingroup window
pub const iconifyWindow = f("glfwIconifyWindow", fn (window: *Window) callconv(.c) void);
...
///
///  @ingroup window
pub const restoreWindow = f("glfwRestoreWindow", fn (window: *Window) callconv(.c) void);
...
///
///  @ingroup window
pub const maximizeWindow = f("glfwMaximizeWindow", fn (window: *Window) callconv(.c) void);
...
///
///  @ingroup window
pub const showWindow = f("glfwShowWindow", fn (window: *Window) callconv(.c) void);
...
///
///  @ingroup window
pub const hideWindow = f("glfwHideWindow", fn (window: *Window) callconv(.c) void);
...
///
///  @ingroup window
pub const focusWindow = f("glfwFocusWindow", fn (window: *Window) callconv(.c) void);
...
///
///  @ingroup window
pub const requestWindowAttention = f("glfwRequestWindowAttention", fn (window: *Window) callconv(.c) void);
...
///
///  @ingroup window
pub const getWindowMonitor = f("glfwGetWindowMonitor", fn (window: *Window) callconv(.c) *Monitor);
...
///
///  @ingroup window
pub const setWindowMonitor = f("glfwSetWindowMonitor", fn (window: *Window, monitor: *Monitor, xpos: c_int, ypos: c_int, width: c_int, height: c_int, refresh_rate: c_int) callconv(.c) void);
...
///
///  @ingroup window
pub const getWindowAttrib = f("glfwGetWindowAttrib", fn (window: *Window, attrib: c_int) callconv(.c) c_int);
...
///
///  @ingroup window
pub const setWindowAttrib = f("glfwSetWindowAttrib", fn (window: *Window, attrib: c_int, value: c_int) callconv(.c) void);
...
///
///  @ingroup window
pub const setWindowUserPointer = f("glfwSetWindowUserPointer", fn (window: *Window, pointer: *anyopaque) callconv(.c) void);
...
///
///  @ingroup window
pub const setWindowPosCallback = f("glfwSetWindowPosCallback", fn (window: *Window, callback: WindowPosFun) callconv(.c) WindowPosFun);
...
///
///  @ingroup window
pub const setWindowSizeCallback = f("glfwSetWindowSizeCallback", fn (window: *Window, callback: WindowSizeFun) callconv(.c) WindowSizeFun);
...
///
///  @ingroup window
pub const setWindowCloseCallback = f("glfwSetWindowCloseCallback", fn (window: *Window, callback: WindowCloseFun) callconv(.c) WindowCloseFun);
...
///
///  @ingroup window
pub const setWindowRefreshCallback = f("glfwSetWindowRefreshCallback", fn (window: *Window, callback: WindowRefreshFun) callconv(.c) WindowRefreshFun);
...
///
///  @ingroup window
pub const setWindowFocusCallback = f("glfwSetWindowFocusCallback", fn (window: *Window, callaback: WindowFocusFun) callconv(.c) WindowFocusFun);
...
///
///  @ingroup window
pub const setWindowIconifyCallback = f("glfwSetWindowIconifyCallback", fn (window: *Window, callback: WindowIconifyFun) callconv(.c) WindowIconifyFun);
...
///
///  @ingroup window
pub const setWindowMaximizeCallback = f("glfwSetWindowMaximizeCallback", fn (window: *Window, callback: WindowmaximizeFun) callconv(.c) WindowmaximizeFun);
...
///
///  @ingroup window
pub const setFramebufferSizeCallback = f("glfwSetFramebufferSizeCallback", fn (window: *Window, callback: FramebufferSizeFun) callconv(.c) FramebufferSizeFun);
...
///
///  @ingroup window
pub const setWindowContentScaleCallback = f("glfwSetWindowContentScaleCallback", fn (window: *Window, callback: WindowContentScaleFun) callconv(.c) WindowContentScaleFun);
...
///
///  @ingroup window
pub const waitEventsTimeout = f("glfwWaitEventsTimeout", fn (timeout: f64) callconv(.c) void);
...
///
///  @ingroup window
pub const postEmptyEvent = f("glfwPostEmptyEvent", fn () callconv(.c) void);
...
///
///  @ingroup input
pub const getInputMode = f("glfwGetInputMode", fn (window: *Window, mode: c_int) callconv(.c) c_int);
...
///
///  @ingroup input
pub const setInputMode = f("glfwSetInputMode", fn (window: *Window, mode: c_int, value: c_int) callconv(.c) void);
...
///
///  @ingroup input
pub const rawMouseMotionSupported = f("glfwRawMouseMotionSupported", fn () callconv(.c) c_int);
...
///
///  @ingroup input
pub const getCursorPos = f("glfwGetCursorPos", fn (window: *Window, xpos: *f64, ypos: *f64) callconv(.c) void);
...
///
///  @ingroup input
pub const setCursorPos = f("glfwSetCursorPos", fn (window: *Window, xpos: f64, ypos: f64) callconv(.c) void);
...
///
///  @ingroup input
pub const createCursor = f("glfwCreateCursor", fn (image: *const Image, xhot: c_int, yhot: c_int) callconv(.c) *Cursor);
...
///
///  @ingroup input
pub const destroyCursor = f("glfwDestroyCursor", fn (cursor: *Cursor) callconv(.c) void);
...
///
///  @ingroup input
pub const setCursor = f("glfwSetCursor", fn (window: *Window, cursor: *Cursor) callconv(.c) void);
...
///
///  @ingroup input
pub const setKeyCallback = f("glfwSetKeyCallback", fn (window: *Window, callback: KeyFun) callconv(.c) KeyFun);
...
///
///  @ingroup input
pub const setCharCallback = f("glfwSetCharCallback", fn (window: *Window, callback: CharFun) callconv(.c) CharFun);
...
///
///  @ingroup input
pub const setCharModsCallback = f("glfwSetCharModsCallback", fn (window: *Window, callback: CharModsFun) callconv(.c) CharModsFun);
...
///
///  @ingroup input
pub const setMouseButtonCallback = f("glfwSetMouseButtonCallback", fn (window: *Window, callback: MouseButtonFun) callconv(.c) MouseButtonFun);
...
///
///  @ingroup input
pub const setCursorPosCallback = f("glfwSetCursorPosCallback", fn (window: *Window, callback: CursorPosFun) callconv(.c) CursorPosFun);
...
///
///  @ingroup input
pub const setCursorEnterCallback = f("glfwSetCursorEnterCallback", fn (window: *Window, callback: CursorEnterFun) callconv(.c) CursorEnterFun);
...
///
///  @ingroup input
pub const setScrollCallback = f("glfwSetScrollCallback", fn (window: *Window, callback: ScrollFun) callconv(.c) ScrollFun);
...
///
///  @ingroup input
pub const setDropCallback = f("glfwSetDropCallback", fn (window: *Window, callback: DropFun) callconv(.c) DropFun);
...
///
///  @ingroup input
pub const setJoystickCallback = f("glfwSetJoystickCallback", fn (callback: JoystickFun) callconv(.c) JoystickFun);
...
///
///  @ingroup input
pub const updateGamepadMappings = f("glfwUpdateGamepadMappings", fn (string: [*:0]const u8) callconv(.c) c_int);
...
///
///  @ingroup input
pub const setClipboardString = f("glfwSetClipboardString", fn (window: *Window, string: [*:0]const u8) callconv(.c) void);
...
///
///  @ingroup input
pub const getClipboardString = f("glfwGetClipboardString", fn (window: *Window) callconv(.c) [*:0]const u8);
...
///
///  @ingroup input
pub const getTime = f("glfwGetTime", fn () callconv(.c) f64);
...
///
///  @ingroup input
pub const setTime = f("glfwSetTime", fn (time: f64) callconv(.c) void);
...
///
///  @ingroup input
pub const getTimerValue = f("glfwGetTimerValue", fn () callconv(.c) u64);
...
///
///  @ingroup input
pub const getTimerFrequency = f("glfwGetTimerFrequency", fn () callconv(.c) u64);
...
///
///  @ingroup context
pub const makeContextCurrent = f("glfwMakeContextCurrent", fn (window: *Window) callconv(.c) void);
...
///
///  @ingroup context
pub const getCurrentContext = f("glfwGetCurrentContext", fn () callconv(.c) *Window);
...
///
///  @ingroup context
pub const swapInterval = f("glfwSwapInterval", fn (interval: c_int) callconv(.c) void);
...
///
///  @ingroup context
pub const extensionSupported = f("glfwExtensionSupported", fn (extension: [*:0]const u8) callconv(.c) c_int);
...
///
///  @ingroup context
pub const getProcAddress = f("glfwGetProcAddress", fn (procname: [*:0]const u8) callconv(.c) GlProc);
...
///
///  @ingroup vulkan
pub const getInstanceProcAddress = f("glfwGetInstanceProcAddress", fn (instance: VkInstance, procname: [*:0]const u8) callconv(.c) VkProc);
...
///
///  @ingroup vulkan
pub const getPhysicalDevicePresentationSupport = f("glfwGetPhysicalDevicePresentationSupport", fn (instance: VkInstance, device: VkPhysicalDevice, queuefamily: u32) callconv(.c) c_int);
